...
`solver`  - настройки солвера name и no_local_search, solver может быть 'powel' или 'dual_annealing'
...
`plot_solution` - рисовать ли результат или нет 

`interp_wavelengths` - длины волн, на которые производится интерполяция
